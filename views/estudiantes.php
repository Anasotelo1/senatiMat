  ...
  <div class="modal fade" id="modal-estudiante" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header bg-warning text-ligth" >
        ...
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            <label for="nrodocumento" class="form-label">NroDocumento</label>
        ...
        <div class="row">
          <div class="mb-3 col-md-6">
            <label for="fechanacimiento" class="form-label">Fecha-Nac</label>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="Guardarestudiante" data-bs-dismiss="modal">Guardar</button>
        </div>
      </div>
    </div>
  </div>
    ...
    $(document).ready(function (){
      ...
      function registrarEstudiante(){
        Swal.fire({
          ...
          //Identificando la accion de usuario 
      ...
      $("#Guardarestudiante").click(registrarEstudiante);
